 ...
 */
final class Version20190615194556 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE reference (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, name VARCHAR(255) NOT NULL COLLATE BINARY, customer VARCHAR(255) NOT NULL COLLATE BINARY, mission CLOB NOT NULL COLLATE BINARY, image VARCHAR(255) DEFAULT NULL COLLATE BINARY, link VARCHAR(255) DEFAULT NULL COLLATE BINARY, created_at DATETIME NOT NULL, image_height INTEGER NOT NULL, caption_image VARCHAR(255) NOT NULL)');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__reference AS SELECT id, name, customer, mission, image, link, created_at, image_height, caption_image FROM reference');
        $this->addSql('DROP TABLE reference');
        $this->addSql('CREATE TABLE reference (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, name VARCHAR(255) NOT NULL, customer VARCHAR(255) NOT NULL, mission CLOB NOT NULL, image VARCHAR(255) DEFAULT NULL, link VARCHAR(255) DEFAULT NULL, created_at DATETIME NOT NULL, image_height INTEGER DEFAULT NULL, caption_image VARCHAR(255) DEFAULT NULL COLLATE BINARY)');
        $this->addSql('INSERT INTO reference (id, name, customer, mission, image, link, created_at, image_height, caption_image) SELECT id, name, customer, mission, image, link, created_at, image_height, caption_image FROM __temp__reference');
        $this->addSql('DROP TABLE __temp__reference');
    }
}
