 ...
 */
final class Version20190616181839 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__article AS SELECT id, author_id, title, image, content, created_at, caption_image, updated_at FROM article');
        $this->addSql('DROP TABLE article');
        $this->addSql('CREATE TABLE article (id INTEGER PRIMARY KEY AUTOINCREMENT DEFAULT NULL, author_id INTEGER DEFAULT NULL, image VARCHAR(255) DEFAULT NULL COLLATE BINARY, caption_image VARCHAR(255) DEFAULT NULL COLLATE BINARY, title VARCHAR(255) DEFAULT NULL, content CLOB DEFAULT NULL, created_at DATETIME DEFAULT NULL, updated_at DATETIME DEFAULT NULL, CONSTRAINT FK_23A0E66F675F31B FOREIGN KEY (author_id) REFERENCES user (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
        $this->addSql('INSERT INTO article (id, author_id, title, image, content, created_at, caption_image, updated_at) SELECT id, author_id, title, image, content, created_at, caption_image, updated_at FROM __temp__article');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('DROP TABLE article');
        $this->addSql('CREATE TABLE article (id INTEGER PRIMARY KEY AUTOINCREMENT DEFAULT NULL, image VARCHAR(255) DEFAULT NULL, caption_image VARCHAR(255) DEFAULT NULL, author_id INTEGER DEFAULT NULL, title VARCHAR(255) DEFAULT NULL COLLATE BINARY, updated_at DATETIME DEFAULT NULL, content CLOB DEFAULT NULL COLLATE BINARY, created_at DATETIME DEFAULT NULL)');
