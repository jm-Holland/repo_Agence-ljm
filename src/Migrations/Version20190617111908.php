 ...
 */
final class Version20190617111908 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__service AS SELECT id, title, description, content, image, updated_at FROM service');
        $this->addSql('DROP TABLE service');
        $this->addSql('CREATE TABLE service (id INTEGER PRIMARY KEY AUTOINCREMENT DEFAULT NULL, title VARCHAR(255) DEFAULT NULL, description CLOB DEFAULT NULL, content CLOB DEFAULT NULL, image VARCHAR(255) DEFAULT NULL, updated_at DATETIME DEFAULT NULL, caption_image VARCHAR(255) DEFAULT NULL)');
        $this->addSql('INSERT INTO service (id, title, description, content, image, updated_at) SELECT id, title, description, content, image, updated_at FROM __temp__service');
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__reference AS SELECT id, link, name, customer, mission, created_at, image_height, caption_image, image, updated_at FROM reference');
        ...
        $this->addSql('INSERT INTO reference (id, link, name, customer, mission, created_at, image_height, caption_image, image, updated_at) SELECT id, link, name, customer, mission, created_at, image_height, caption_image, image, updated_at FROM __temp__reference');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__service AS SELECT id, title, description, content, image, updated_at FROM service');
        $this->addSql('DROP TABLE service');
        $this->addSql('CREATE TABLE service (id INTEGER PRIMARY KEY AUTOINCREMENT DEFAULT NULL, title VARCHAR(255) DEFAULT NULL COLLATE BINARY, description CLOB DEFAULT NULL COLLATE BINARY, content CLOB DEFAULT NULL COLLATE BINARY, image VARCHAR(255) DEFAULT NULL COLLATE BINARY, updated_at DATETIME DEFAULT NULL)');
        $this->addSql('INSERT INTO service (id, title, description, content, image, updated_at) SELECT id, title, description, content, image, updated_at FROM __temp__service');
        $this->addSql('DROP TABLE __temp__service');
    }
}
