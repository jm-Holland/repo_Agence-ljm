 ...
 */
final class Version20190625162157 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__customer AS SELECT id, first_name, last_name, email, company, subject, address, postal_code, city, country, content FROM customer');
        $this->addSql('DROP TABLE customer');
        $this->addSql('CREATE TABLE customer (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, first_name VARCHAR(255) NOT NULL COLLATE BINARY, last_name VARCHAR(255) NOT NULL COLLATE BINARY, email VARCHAR(255) NOT NULL COLLATE BINARY, company VARCHAR(255) DEFAULT NULL COLLATE BINARY, subject VARCHAR(255) NOT NULL COLLATE BINARY, city VARCHAR(255) NOT NULL COLLATE BINARY, country VARCHAR(255) NOT NULL COLLATE BINARY, content CLOB NOT NULL COLLATE BINARY, address VARCHAR(255) NOT NULL, postal_code VARCHAR(255) NOT NULL)');
        $this->addSql('INSERT INTO customer (id, first_name, last_name, email, company, subject, address, postal_code, city, country, content) SELECT id, first_name, last_name, email, company, subject, address, postal_code, city, country, content FROM __temp__customer');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE client (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, first_name VARCHAR(255) NOT NULL COLLATE BINARY, last_name VARCHAR(255) NOT NULL COLLATE BINARY, email VARCHAR(255) NOT NULL COLLATE BINARY, organisation VARCHAR(255) DEFAULT NULL COLLATE BINARY, subject VARCHAR(255) NOT NULL COLLATE BINARY, address VARCHAR(255) DEFAULT NULL COLLATE BINARY, code_postal VARCHAR(255) DEFAULT NULL COLLATE BINARY, city VARCHAR(255) DEFAULT NULL COLLATE BINARY, country VARCHAR(255) DEFAULT NULL COLLATE BINARY, content CLOB NOT NULL COLLATE BINARY)');
        $this->addSql('DROP INDEX IDX_23A0E66F675F31B');
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__customer AS SELECT id, first_name, last_name, email, company, subject, address, postal_code, city, country, content FROM customer');
        $this->addSql('DROP TABLE customer');
        $this->addSql('CREATE TABLE customer (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, first_name VARCHAR(255) NOT NULL, last_name VARCHAR(255) NOT NULL, email VARCHAR(255) NOT NULL, company VARCHAR(255) DEFAULT NULL, subject VARCHAR(255) NOT NULL, city VARCHAR(255) NOT NULL, country VARCHAR(255) NOT NULL, content CLOB NOT NULL, address VARCHAR(255) DEFAULT NULL COLLATE BINARY, postal_code VARCHAR(255) DEFAULT NULL COLLATE BINARY)');
        $this->addSql('INSERT INTO customer (id, first_name, last_name, email, company, subject, address, postal_code, city, country, content) SELECT id, first_name, last_name, email, company, subject, address, postal_code, city, country, content FROM __temp__customer');
        $this->addSql('DROP TABLE __temp__customer');
    }
}
