 ...
 */
final class Version20190702101548 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE customer ADD COLUMN agree_rgpd BOOLEAN DEFAULT NULL');
